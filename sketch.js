...
function draw() { 
  ...
  if(gameState === 1)
  {
    ...
    fill("cyan")
    textSize(20)
    text("Select difficulty to start the game", 350, 150)
    textSize(15)
    text("Press E for easy, M for medium, H for hard", 350, 350)
    if(keyDown("h"))
    {
      gameState = 2; 
      chance = 3;
  ...
  if(gameState === 2)
  {
    ...
    text("chances = " + chance, 500, 100)
    text("boxes left ="+ count, 600, 420)
    fill("skyblue")
  block1.display();
  block2.display();
  block3.display();
